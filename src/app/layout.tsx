...
export const metadata: Metadata = {
  title: "Business Coaching | Transform Your Company | CoachFlow",  description: "Expert business coaching for entrepreneurs and executives. Get personalized strategies for growth, leadership development, and sustainable success. Free consultation available.",  keywords: "business coaching, executive coaching, business growth, leadership coaching, business consultant, entrepreneur mentor",  metadataBase: new URL("https://coachflow.com"),
  alternates: {
    canonical: "https://coachflow.com"
  },
  openGraph: {
    title: "Business Coaching | Transform Your Company",    description: "Expert coaching for entrepreneurs and executives. Build thriving businesses with proven strategies.",    url: "https://coachflow.com",    siteName: "CoachFlow",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/businessman-suit-working-tablet-with-charts-conference-room-team-brainstorm_482257-31840.jpg",        alt: "Professional business coaching"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Business Coaching | Transform Your Company",    description: "Expert coaching for entrepreneurs and executives. Get proven strategies for growth and success.",    images: ["http://img.b2bpic.net/free-photo/businessman-suit-working-tablet-with-charts-conference-room-team-brainstorm_482257-31840.jpg"]
  },
  robots: {
    index: true,
    follow: true
